...
const Index = () => {
  ...
  const projectImages = [{
    ...
    description: "Residência com paredes erguidas em EPS, oferecendo alta eficiência térmica e rapidez na obra."
  }, {
    ...
    description: "Casa com estrutura EPS já recebendo acabamento, destacando a resistência e qualidade do sistema."
  }, {
    src: "/lovable-uploads/cfcf0588-0c43-483e-83dc-d8501b8776be.png",
    title: "Interior da Estrutura EPS",
    description: "Detalhes do interior durante a montagem, comprovando a precisão e o isolamento térmico proporcionado."
  }, {
    src: "/lovable-uploads/41fc5186-5622-48dc-8a88-050295618a4d.png",
    title: "Ambiente Interno Finalizado",
    description: "Espaço interno após fechamento das paredes, destacando a versatilidade do EPS e a qualidade do acabamento."
  }];
            ...
            <CardContent className="p-8">
              <form onSubmit={handleMainSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Select 
                    value={mainForm.tipoProjeto} 
                    onValueChange={value => setMainForm({
                      ...mainForm,
                      tipoProjeto: value
                    })}
                  >
