          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-6">
                  ...
                  <form onSubmit={handleHeroSubmit} className="space-y-4">
                    <div>
                      <Input placeholder="Seu nome*" value={heroForm.nome} onChange={e => setHeroForm({
                      ...heroForm,
                      nome: e.target.value
                    })} className="bg-white/20 border-white/30 text-white placeholder:text-white/70" required />
                    </div>
                    <div>
                      <Input placeholder="Nome da empresa (opcional)" value={heroForm.empresa} onChange={e => setHeroForm({
                      ...heroForm,
                      empresa: e.target.value
                    })} className="bg-white/20 border-white/30 text-white placeholder:text-white/70" />
                    </div>
                    <div>
                      <Input placeholder="Tipo de projeto*" value={heroForm.projeto} onChange={e => setHeroForm({
                      ...heroForm,
                      projeto: e.target.value
                    })} className="bg-white/20 border-white/30 text-white placeholder:text-white/70" required />
                    </div>
                    <div>
                      <Input placeholder="Email ou telefone*" value={heroForm.contato} onChange={e => setHeroForm({
                      ...heroForm,
            ...
            <div className="relative">
              <div className="aspect-video rounded-lg shadow-2xl overflow-hidden">
                <img src="/lovable-uploads/81e54642-3102-4b22-82e9-a75b83aefb05.png" alt="Placas de EPS Moduart - Qualidade e Tecnologia para Construção" className="w-full h-full object-cover" />
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {projectImages.map((project, index) => <Card key={index} className="border-0 shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent className="p-6">
                  <h3 className="text-lg font-semibold mb-2">Estrutura Avançada em EPS</h3>
              ...
              <form onSubmit={handleMainSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input id="nomeCompleto" value={mainForm.nomeCompleto} onChange={e => setMainForm({
                    ...mainForm,
                  ...
                  <div>
                    ...
                    <Input id="empresa" value={mainForm.empresa} onChange={e => setMainForm({
                    ...mainForm,
                    empresa: e.target.value
                  })} placeholder="Opcional" className="mt-2" />
                  </div>
                </div>

                <div>
                  <Label htmlFor="tipoProjeto">Tipo de Projeto *</Label>
                  <Select value={mainForm.tipoProjeto} onValueChange={value => setMainForm({
                  ...mainForm,
                  tipoProjeto: value
                })}>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input id="email" type="email" value={mainForm.email} onChange={e => setMainForm({
                    ...mainForm,
                  ...
                  <div>
                    ...
                    <Input id="telefone" value={mainForm.telefone} onChange={e => setMainForm({
                    ...mainForm,
                    telefone: e.target.value
                  })} placeholder="(41) 99999-9999" required className="mt-2" />
                  </div>
                </div>
